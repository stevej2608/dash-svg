...
/**
 * Image is a wrapper for the <image> SVG element.
...
Image.propTypes = {
     ...
     *  inside the image.BCD tables only load in the browser
     */
    ...
    /**
     *  The image-rendering attribute provides a hint to the browser
