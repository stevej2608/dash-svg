...
Pattern.propTypes = {
     ...
     *  definition.BCD tables only load in the browser
     */
    patternTransform: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),

    /**
     *  The patternUnits attribute indicates which coordinate system
