...
/**
 * FeComposite is a wrapper for the <feComposite> SVG element.
 * For detailed attribute info see:
 * https://developer.mozilla.org/en-US/docs/Web/SVG/Element/feComposite
 */
const FeComposite = (props) => {
...
FeComposite.propTypes = {
     ...
     *  the pixels in the image defined in the in attribute.
     */
     ...
     */
    k1: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
     ...
     *  tables only load in the browser
     */
    k2: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
     ...
     *  tables only load in the browser
     */
    k3: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
     ...
     *  tables only load in the browser
     */
    k4: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
