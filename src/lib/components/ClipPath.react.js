...
ClipPath.propTypes = {
    ...
    /**
     *  The clipPathUnits attribute indicates which coordinate system
     ...
     *  have a length of 1 unit value.
     */
    clipPathUnits: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
